...
Табът **Статии** съдържа списък на всички статии, филтри, добавяне, редакция и групово изтриване. Списъкът и формата за статия използват същата основна навигация **Настройки / Категории / Статии**, така че администрацията остава в един общ интерфейс.
...
Формата за статия е разделена на вътрешни табове **Съдържание / Данни / Изображения**.
...
4. Проверете основната навигация **Настройки / Категории / Статии**.
5. Отворете **Статии** и проверете списъка, филтрите, добавянето и редакцията.

Миграцията от 0.8.0/0.9.0 запазва съществуващите категории, статии, SEO URL адреси и multi-store настройки.
