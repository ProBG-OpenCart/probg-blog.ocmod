...
1. Изтеглете `probg-blog-1.7.0.ocmod.zip` от GitHub Release или директорията `dist/`.
...
1. Download `probg-blog-1.7.0.ocmod.zip` from the GitHub Release or the `dist/` directory.
